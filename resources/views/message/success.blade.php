...
<section id="main-section">
    <div class="container m-t-20 m-b-40 flex-col-c-m">
       <div class="fs-30 font-bold m-t-40">Thank you!</div>
       <div class="fs-30 font-bold m-b-40">Your Payment Has Been Processed</div>
       <div class="">
        <img src="{{ url("images/success.png") }}" alt="" class="m-b-40">
       </div>
